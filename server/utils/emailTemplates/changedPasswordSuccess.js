                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#f4f3f3">
                    <tr>
                        <td align="center" style="padding: 40px 0;">
                                ...
                                <tr>
                                    <td align="left" style="padding: 40px; text-align: left;">
                                        ...
                                        <div style="margin-top: 30px; text-align: center;">
                                            <a href="https://www.linkedin.com/in/raj-devvanshi-a4a08430b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" style="margin: 0 10px; text-decoration: none;">
                                                <img src="https://cdn-icons-png.flaticon.com/512/174/174857.png" alt="LinkedIn" width="24" height="24" />
                                            </a>
                                            <a href="https://github.com/" style="margin: 0 10px; text-decoration: none;">
                                                <img src="https://cdn-icons-png.flaticon.com/512/25/25231.png" alt="GitHub" width="24" height="24" />
                                            </a>
                                            <a href="https://" style="margin: 0 10px; text-decoration: none;">
                            ...
                            <p style="color: #9A9A9A; font-size: 12px; margin-top: 20px;">This message was sent from Raj & Company Pvt. Ltd, Firoshepur, Jaunpur India 222001</p>
