          ...
          <div className="about-content">
            <div className="left-side">
              <div className="address details">
                ...
                <div className="text-one">Firoshepur, Jaunpur</div>
                <div className="text-two">UP, 222001.</div>
              </div>
              ...
              <div className="email details">
                ...
                <div className="text-one">
                  <a href="mailto:rajdevvanshi6392@gmail.com">
                    rajdevvanshi6392@gmail.com
                  </a>
                </div>
                <div className="text-two">
                  <a href="mailto:rajdevvanshi639237@gmail.com">
                    rajdevvanshi639237@gmail.com
                  </a>
                </div>
              </div>
            </div>
